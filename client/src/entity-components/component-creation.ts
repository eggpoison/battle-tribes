...
export function createComponent(entity: Entity, componentType: ServerComponentType): ServerComponent {
   switch (componentType) {
      ...
      case ServerComponentType.tunnel: return new TunnelComponent(entity);
      case ServerComponentType.buildingMaterial: return new BuildingMaterialComponent(entity);
      ...
      case ServerComponentType.tribeMember: return new TribeMemberComponent(entity);
      case ServerComponentType.healingTotem: return new HealingTotemComponent(entity);
      case ServerComponentType.planterBox: return new PlanterBoxComponent(entity);
      case ServerComponentType.plant: return new PlantComponent(entity);
      case ServerComponentType.structure: return new StructureComponent(entity);
      ...
      case ServerComponentType.tribeWarrior: return new TribeWarriorComponent(entity);
      case ServerComponentType.layeredRod: return new LayeredRodComponent(entity);
      case ServerComponentType.decoration: return new DecorationComponent(entity);
