...
import { deselectSelectedEntity, getSelectedEntityID } from "../../game/entity-selection";
import { GhostInfo, GhostType, PARTIAL_OPACITY } from "../../game/rendering/webgl/entity-ghost-rendering";
