...
class _HealingTotemComponentArray extends ServerComponentArray<HealingTotemComponent, HealingTotemComponentData> {
   ...
   public createComponent(entityComponentData: EntityComponentData): HealingTotemComponent {
   ...
   public updateFromData(data: HealingTotemComponentData, entity: Entity): void {
      const healingTotemComponent = HealingTotemComponentArray.getComponent(entity);
      healingTotemComponent.healingTargetsData = data.healingTargetsData;
   }
}

export const HealingTotemComponentArray = registerServerComponentArray(ServerComponentType.healingTotem, _HealingTotemComponentArray, true);
