<script lang="ts">
   import { Tech, TechID } from "webgl-test-shared/src/techs";
   ...
   import { InventoryName } from "webgl-test-shared/src/items/items";
   import { ItemTally2, tallyInventoryItems } from "webgl-test-shared/src/items/ItemTally";
   import { Point, randFloat, randAngle } from "webgl-test-shared/src/utils";
