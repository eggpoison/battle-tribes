...
export function createBallistaWoodenBoltConfig(tribe: Tribe, creator: EntityID): EntityConfig<ComponentTypes> {
...
export function onBallistaWoodenBoltCollision(arrow: EntityID, collidingEntity: EntityID, collisionPoint: Point): void {
