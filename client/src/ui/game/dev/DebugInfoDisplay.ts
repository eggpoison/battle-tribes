...
import { sendDevSetViewedSpawnDistributionPacket, sendSpectateEntityPacket, sendToggleSimulationPacket } from "../../../game/networking/packet-sending/packet-sending";
...
export function DebugInfoDisplay_updateCurrentSnapshot(snapshot: PacketSnapshot): void {
