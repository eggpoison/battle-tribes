...
declare module "../component-registry" {
   interface ServerComponentRegistry extends RegisterServerComponent<ServerComponentType.tundraRock, typeof TundraRockComponentArray> {}
}

export const TundraRockComponentArray = registerServerComponentArray(
