...
declare module "../component-registry" {
   interface ServerComponentRegistry extends RegisterServerComponent<ServerComponentType.inguYetuksnoglurblidokowflea, typeof InguYetuksnoglurblidokowfleaComponentArray> {}
}

export const InguYetuksnoglurblidokowfleaComponentArray = registerServerComponentArray(
   ServerComponentType.inguYetuksnoglurblidokowflea,
   new ServerComponentArray(true, createComponent, getMaxRenderParts, decodeData)
);
InguYetuksnoglurblidokowfleaComponentArray.populateIntermediateInfo = populateIntermediateInfo;
InguYetuksnoglurblidokowfleaComponentArray.onTick = onTick;

function decodeData(): InguYetuksnoglurblidokowfleaComponentData {
   return {};
}
