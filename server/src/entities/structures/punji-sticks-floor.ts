...
export function createFloorPunjiSticksConfig(x: number, y: number, rotation: number, tribe: Tribe, connections: StructureConnection[], virtualStructure: VirtualStructure | null): EntityConfig {
