...
declare module "../component-registry" {
   interface ServerComponentRegistry extends RegisterServerComponent<ServerComponentType.snobe, typeof SnobeComponentArray> {}
}

export const SnobeComponentArray = registerServerComponentArray(
