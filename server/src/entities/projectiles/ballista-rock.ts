...
export function createBallistaRockConfig(tribe: Tribe, creator: EntityID): EntityConfig<ComponentTypes> {
...
export function onBallistaRockCollision(arrow: EntityID, collidingEntity: EntityID, collisionPoint: Point): void {
