import { Point, randFloat, randInt, TileIndex, UtilVars } from "webgl-test-shared/dist/utils";
import { EntityID, EntityType, FrozenYetiAttackType, PlayerCauseOfDeath, SnowballSize } from "webgl-test-shared/dist/entities";
