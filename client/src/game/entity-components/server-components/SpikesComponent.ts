...
declare module "../component-registry" {
   interface ServerComponentRegistry extends RegisterServerComponent<ServerComponentType.spikes, typeof SpikesComponentArray> {}
}
...
export const SpikesComponentArray = registerServerComponentArray(
