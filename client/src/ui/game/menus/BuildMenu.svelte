<script lang="ts">
   ...
   import WoodenEmbrasureImage from "$images/entities/embrasure/wooden-embrasure.png";
   import WoodenDoorImage from "$images/entities/door/wooden-door.png";
   import WoodenTunnelImage from "$images/entities/door/wooden-door.png";
   import WarriorHutImage from "$images/entities/warrior-hut/warrior-hut.png";
   import StoneWallImage from "$images/entities/wall/stone-wall.png";
   import StoneTunnelImage from "$images/entities/tunnel/stone-tunnel.png";
   import StoneDoorImage from "$images/entities/door-stone-door.png";
   import StoneEmbrasureImage from "$images/entities/embrasure/stone-embrasure.png";
   import StoneFloorSpikesImage from "$images/entities/spikes/stone-floor-spikes.png";
   import StoneWallSpikesImage from "$images/entities/spikes/stone-wall-spikes.png";
   import StoneVerticalPostImage from "$images/entities/spikes/stone-wall-spikes.png";
   import TunnelDoorImage from "$images/entities/tunnel/tunnel-door.png";
   import CoverSpikesIcon from "$images/miscellaneous/cover-spikes.png";
   import DeconstructIcon from "$images/miscellaneous/deconstruct.png";
   import RecallHutIcon from "$images/miscellaneous/recall.png";
   import ShovelPlantIcon from "$images/miscellaneous/shovel.png";
   import ConvertToFenceGateIcon from "$images/miscellaneous/full-fence-gate.png";
