...
export function createSnowberryBushConfig(x: number, y: number, angle: number): EntityConfig {
   ...
   const hitbox = createHitbox(transformComponent, null, createCircularBox(x, y, 0, 0, angle, 34), 0.9, HitboxCollisionType.soft, CollisionBit.plant, DEFAULT_COLLISION_MASK);
