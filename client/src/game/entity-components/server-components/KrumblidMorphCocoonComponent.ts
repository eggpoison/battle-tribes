...
class _KrumblidMorphCocoonComponentArray extends _ServerComponentArray<KrumblidMorphCocoonComponent, KrumblidMorphCocoonComponentData, IntermediateInfo> {
   ...
   public createComponent(entityComponentData: EntityComponentData, intermediateInfo: IntermediateInfo): KrumblidMorphCocoonComponent {
      const serverComponentTypes = getEntityServerComponentTypes(entityComponentData.entityType);
      const krumblidMorphCocoonComponentData = getServerComponentData(entityComponentData.serverComponentData, serverComponentTypes, ServerComponentType.krumblidMorphCocoon);
   ...
   public updateFromData(data: KrumblidMorphCocoonComponentData, entity: Entity): void {
