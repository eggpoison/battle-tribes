...
declare module "../component-registry" {
   interface ServerComponentRegistry extends RegisterServerComponent<ServerComponentType.yeti, typeof YetiComponentArray> {}
}
...
export const YetiComponentArray = registerServerComponentArray(
