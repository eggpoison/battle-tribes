...
declare module "../component-registry" {
   interface ServerComponentRegistry extends RegisterServerComponent<ServerComponentType.tribe, typeof TribeComponentArray> {}
}

export const TribeComponentArray = registerServerComponentArray(
