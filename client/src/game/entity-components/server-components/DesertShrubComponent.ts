...
class _DesertShrubComponentArray extends _ServerComponentArray<DesertShrubComponent, DesertShrubComponentData> {
   ...
   public createComponent(): DesertShrubComponent {
      return {};
   }
...
export const DesertShrubComponentArray = registerServerComponentArray(ServerComponentType.desertShrub, _DesertShrubComponentArray, true);