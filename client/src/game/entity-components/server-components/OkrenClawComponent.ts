...
declare module "../component-registry" {
   interface ServerComponentRegistry extends RegisterServerComponent<ServerComponentType.okrenClaw, typeof OkrenClawComponentArray> {}
}

export const OkrenClawComponentArray = registerServerComponentArray(
   ServerComponentType.okrenClaw,
