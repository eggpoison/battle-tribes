<script lang="ts">
   import { InventoryName, itemTypeIsArmour, itemTypeIsBackpack } from "webgl-test-shared/src/items/items";
...
<div id="tribesman-inventory" class="menu" oncontextmenu={e => e.preventDefault()}>
   ...
   {#if tribeComponent.tribeID === playerTribe.id}
      <div class="hotbar-container">
         ...
         <div class="inventory">
            <ItemSlot className="armour-slot" entityID={playerID} inventory={backpackSlotInventory} itemSlot={1} placeholderImg={require("../../../images/miscellaneous/backpack-wireframe.png")} validItemSpecifier={itemTypeIsBackpack} />
            <ItemSlot className="backpack-slot" entityID={playerID} inventory={armourSlotInventory} itemSlot={1} placeholderImg={require("../../../images/miscellaneous/armour-wireframe.png")} validItemSpecifier={itemTypeIsArmour} />
         </div>
      </div>
   {/if}
</div>