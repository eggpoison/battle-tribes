...
declare module "../component-registry" {
   interface ServerComponentRegistry extends RegisterServerComponent<ServerComponentType.tunnel, typeof TunnelComponentArray> {}
}
...
export const TunnelComponentArray = registerServerComponentArray(
