...
declare module "../component-registry" {
   interface ServerComponentRegistry extends RegisterServerComponent<ServerComponentType.moss, typeof MossComponentArray> {}
}

export const MossComponentArray = registerServerComponentArray(
