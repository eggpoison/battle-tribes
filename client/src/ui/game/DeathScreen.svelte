<script lang="ts">
   import { randItem } from "webgl-test-shared/src/utils";
...
<div id="death-screen">
   <div class="content">
      ...
      {#if secondsInScreen < RESPAWN_TIME_SECONDS}
         <p class="respawn-countdown">{RESPAWN_TIME_SECONDS - 1 - secondsInScreen}</p>
      {:else}
...
<style>
   ...
   #death-screen .button-container button {
      font-family: "PT Serif";
      font-size: 1rem;
   ...
   #death-screen .button-container button:hover:not(:active) {
      color: #222;
   ...
   #death-screen .respawn-countdown {
      ...
      font-size: 2.5rem;
      color: red;
      text-shadow: 2px 2px 5px 1px rgba(0, 0, 0, 0.4);
   }
</style>