import { LimbState, LimbConfiguration, RESTING_LIMB_STATES, copyLimbState, interpolateLimbState, AttackVar, SHIELD_BLOCKING_LIMB_STATE, BLOCKING_LIMB_STATE } from "../../../shared/dist/attack-patterns.js";
import { HitboxTag, Box, createRectangularBox, getBoxCollisionResult, calculateBoxBounds, _bounds, assertBoxIsCircular } from "../../../shared/dist/boxes.js";
import { BlockType, ServerComponentType } from "../../../shared/dist/components.js";
import { LimbAction, Entity, EntityType, DamageSource } from "../../../shared/dist/entities.js";
import { AttackEffectiveness, calculateAttackEffectiveness } from "../../../shared/dist/entity-damage-types.js";
import { Inventory, InventoryName, Item, getItemAttackInfo, QUIVER_PULL_TIME_TICKS, ITEM_INFO_RECORD, ItemType, BowItemInfo, RETURN_FROM_BOW_USE_TIME_TICKS, ITEM_TYPE_RECORD, HammerItemType, itemTypeIsHammer } from "../../../shared/dist/items/items.js";
import { Packet } from "../../../shared/dist/packets.js";
import { Settings } from "../../../shared/dist/settings.js";
import { StatusEffect } from "../../../shared/dist/status-effects.js";
import { TribesmanTitle } from "../../../shared/dist/titles.js";
import { Point, lerp, customTickIntervalHasPassed, polarVec2, randAngle, angle } from "../../../shared/dist/utils.js";
...
import { calculateItemKnockback } from "../entities/tribes/limb-use.js";
import { calculateItemDamage } from "../entities/tribes/tribe-member.js";
import { createItem } from "../items.js";
import { BerryBushComponentArray } from "./BerryBushComponent.js";
import { BerryBushPlantedComponentArray } from "./BerryBushPlantedComponent.js";
import { doBlueprintWork } from "./BlueprintComponent.js";
import { HealthComponentArray, hitEntityWithoutDamage, damageEntity, healEntity } from "./HealthComponent.js";
import { applyStatusEffect } from "./StatusEffectComponent.js";
import { getEntityRelationship, EntityRelationship, entitiesBelongToSameTribe, TribeComponentArray } from "./TribeComponent.js";
import { hasTitle } from "./TribesmanComponent.js";
import { createHeldItemConfig } from "../entities/held-item.js";
