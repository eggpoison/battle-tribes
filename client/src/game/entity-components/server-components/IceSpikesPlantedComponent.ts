...
declare module "../component-registry" {
   interface ServerComponentRegistry extends RegisterServerComponent<ServerComponentType.iceSpikesPlanted, typeof IceSpikesPlantedComponentArray> {}
}

export const IceSpikesPlantedComponentArray = registerServerComponentArray(
