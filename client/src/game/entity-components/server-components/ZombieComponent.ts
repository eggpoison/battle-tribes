...
class _ZombieComponentArray extends _ServerComponentArray<ZombieComponent, ZombieComponentData> {
   ...
   public createComponent(entityComponentData: EntityComponentData): ZombieComponent {
      const serverComponentTypes = getEntityServerComponentTypes(entityComponentData.entityType);
      const zombieComponentData = getServerComponentData(entityComponentData.serverComponentData, serverComponentTypes, ServerComponentType.zombie);
      return {
...
export const ZombieComponentArray = registerServerComponentArray(ServerComponentType.zombie, _ZombieComponentArray, true);