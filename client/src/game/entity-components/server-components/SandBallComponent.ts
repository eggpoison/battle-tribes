...
declare module "../component-registry" {
   interface ServerComponentRegistry extends RegisterServerComponent<ServerComponentType.sandBall, typeof SandBallComponentArray> {}
}

export const SandBallComponentArray = registerServerComponentArray(
