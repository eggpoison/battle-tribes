...
import { getElapsedTimeInSeconds } from "../../game/Board";
import { sendStopItemUsePacket, sendItemDropPacket, sendItemUsePacket, sendStartItemUsePacket, sendSpectateEntityPacket, sendDismountCarrySlotPacket, sendSetMoveTargetPositionPacket, sendSelectRiderDepositLocationPacket, sendAttackPacket } from "../../game/networking/packet-sending";
import { createHealthComponentData, HealthComponentArray } from "../../game/entity-components/server-components/HealthComponent";
import { createInventoryComponentData, getInventory, InventoryComponentArray, updatePlayerHeldItem } from "../../game/entity-components/server-components/InventoryComponent";
import { getCurrentLimbState, getLimbByInventoryName, getLimbConfiguration, InventoryUseComponentArray, LimbInfo } from "../../game/entity-components/server-components/InventoryUseComponent";
import { attemptEntitySelection, getHoveredEntityID, getSelectedEntityID } from "../../game/entity-selection";
import { addKeyListener, keyIsPressed } from "../../game/keyboard-input";
import { closeCurrentMenu } from "../../game/menus";
import { addGhostRenderInfo, removeGhostRenderInfo } from "../../game/rendering/webgl/entity-ghost-rendering";
import { attemptToCompleteNode } from "../../game/research";
import { playHeadSound, playSoundOnHitbox } from "../../game/sound";
...
import { createTransformComponentData, TransformComponentArray } from "../../game/entity-components/server-components/TransformComponent";
...
import { createEntityCreationInfo, entityExists, EntityComponentData, getCurrentLayer, getEntityLayer } from "../../game/world";
import { TribesmanComponentArray, tribesmanHasTitle } from "../../game/entity-components/server-components/TribesmanComponent";
import { createStatusEffectComponentData, StatusEffectComponentArray } from "../../game/entity-components/server-components/StatusEffectComponent";
import { EntityComponents, ServerComponentType, BuildingMaterial } from "../../../../shared/src/components";
import { applyAccelerationFromGround, getHitboxVelocity, Hitbox, setHitboxVelocity } from "../../game/hitboxes";
import { createBracingsComponentData } from "../../game/entity-components/server-components/BracingsComponent";
import { createBuildingMaterialComponentData } from "../../game/entity-components/server-components/BuildingMaterialComponent";
import { createStructureComponentData } from "../../game/entity-components/server-components/StructureComponent";
import { TribeComponentArray, createTribeComponentData } from "../../game/entity-components/server-components/TribeComponent";
import { thingIsVisualRenderPart } from "../../game/render-parts/render-parts";
import { createCookingComponentData } from "../../game/entity-components/server-components/CookingComponent";
import { createCampfireComponentData } from "../../game/entity-components/server-components/CampfireComponent";
import { createFurnaceComponentData } from "../../game/entity-components/server-components/FurnaceComponent";
import { createSpikesComponentData } from "../../game/entity-components/server-components/SpikesComponent";
import HeldItemSlot from "./HeldItemSlot";
import { createFireTorchComponentData } from "../../game/entity-components/server-components/FireTorchComponent";
import { createSlurbTorchComponentData } from "../../game/entity-components/server-components/SlurbTorchComponent";
import { createBarrelComponentData } from "../../game/entity-components/server-components/BarrelComponent";
import { playerTribe } from "../../game/tribes";
import { EntityRenderInfo } from "../../game/EntityRenderInfo";
import { createResearchBenchComponentData } from "../../game/entity-components/server-components/ResearchBenchComponent";
import { GameInteractState } from "./GameScreen";
import { BlockAttackComponentArray } from "../../game/entity-components/server-components/BlockAttackComponent";
...
import { isSpectating, playerInstance } from "../../game/player";
import { AnimalStaffCommandType, createControlCommandParticles } from "./AnimalStaffOptions";
import  { currentSnapshot } from "../../game/client";
import { calculateEntityPlaceInfo } from "../../game/structure-placement";
import { assert, Point } from "../../../../shared/src/utils";
import { getEntityClientComponentConfigs } from "../../game/entity-components/client-components";
import { EntityServerComponentData } from "../../game/networking/packet-snapshots";
import { cursorWorldPos } from "../../game/mouse-input-input";
