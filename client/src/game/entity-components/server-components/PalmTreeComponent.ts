...
declare module "../component-registry" {
   interface ServerComponentRegistry extends RegisterServerComponent<ServerComponentType.palmTree, typeof PalmTreeComponentArray> {}
}

export const PalmTreeComponentArray = registerServerComponentArray(
