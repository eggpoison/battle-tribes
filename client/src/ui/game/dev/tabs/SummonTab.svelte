import { EntityType, NUM_ENTITY_TYPES } from "webgl-test-shared/src/entities";
import CLIENT_ENTITY_INFO_RECORD from "../../../../game/client-entity-info";
import { MutableRefObject, useCallback, useState } from "react";
import DevmodeRangeInput from "../DevmodeRangeInput";
import { ComponentSummonData, EntitySummonData, EntitySummonPacket } from "webgl-test-shared/src/dev-packets";
import { EntityComponents, ServerComponentType } from "webgl-test-shared/src/components";
import TribeComponentInput from "./TribeComponentInput";
import DevmodeScrollableOptions from "../DevmodeScrollableOptions";
import { Inventory, InventoryName, ItemSlots } from "webgl-test-shared/src/items/items";
