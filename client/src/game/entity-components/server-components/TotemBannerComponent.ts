...
declare module "../component-registry" {
   interface ServerComponentRegistry extends RegisterServerComponent<ServerComponentType.totemBanner, typeof TotemBannerComponentArray> {}
}

const BANNER_LAYER_DISTANCES = [34, 52, 65];

export const TotemBannerComponentArray = registerServerComponentArray(
