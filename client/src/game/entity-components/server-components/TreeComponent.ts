...
declare module "../component-registry" {
   interface ServerComponentRegistry extends RegisterServerComponent<ServerComponentType.tree, typeof TreeComponentArray> {}
}
...
export const TreeComponentArray = registerServerComponentArray(
