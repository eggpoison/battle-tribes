...
declare module "../component-registry" {
   interface ServerComponentRegistry extends RegisterServerComponent<ServerComponentType.structure, typeof StructureComponentArray> {}
}

export const StructureComponentArray = registerServerComponentArray(
