...
//       visibleEntities = this.filterTargets(visibleEntities);
//       return visibleEntities !== null;
//    }

//    protected filterTargets(entityArray: ReadonlyArray<Entity>): Array<Entity> {
//       let entities = entityArray.slice();
//       entities = super.filterTargets(entities);
...
//       entities = this.filterTargets(entities);
...
export function fsideuyidufs(): number { return 1 }