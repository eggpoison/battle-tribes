...
import { StatusEffectData } from "webgl-test-shared/src/client-server-types";
import { StatusEffect } from "webgl-test-shared/src/status-effects";
import { customTickIntervalHasPassed, lerp, randAngle, randFloat, randItem } from "webgl-test-shared/src/utils";
