<script lang="ts">
   import { Inventory, ItemType } from "webgl-test-shared/src/items/items";
...
<div oncontextmenu={typeof props.onContextMenu !== "undefined" ? (e => props.onContextMenu!(e.nativeEvent)) : undefined}
   ...
   {#if (typeof props.restTime !== "undefined" && props.restTime.durationTicks > 0)}
      <div class="cooldown-bg" style={{"--cooldown": (props.restTime.remainingTimeTicks / props.restTime.durationTicks).toString()} as React.CSSProperties}></div>
   {/if}
</div>
