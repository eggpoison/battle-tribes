...
export function createBoulder(position: Point, rotation: number): Entity {
   ...
   const hitbox = new CircularHitbox(1.25, new Point(0, 0), HitboxCollisionType.soft, HitboxCollisionBit.DEFAULT, DEFAULT_HITBOX_COLLISION_MASK, boulder.getNextHitboxLocalID(), 0, RADIUS);
